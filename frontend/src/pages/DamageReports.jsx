...
export default function DamageReports() {
  ...
  const handleForward = async (id) => {
    try { await API.patch(`/damage-reports/${id}/forward`); fetch(); } catch {}
  };
    ...
    <div className="animate-in">
      <header className="flex justify-between items-end mb-8">
        ...
        <div className="flex gap-2">
          <button className="btn-ghost" onClick={fetch}><RefreshCw size={15}/> Refresh</button>
          {isStaff && (
        ...
        {loading ? (
          ...
          <div key={report.id} className="glass-card" style={{padding:'1.25rem 1.5rem'}}>
            <div className="flex justify-between items-start mb-3">
              ...
              {/* Department Head: Forward button */}
